        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list {{ Request::is('category') ? 'active' : '' }}"><i class="fa fa-thumb-tack"></i>
                        <a class="sidebar-link sidebar-title link-nav" href="{{ route('category.index') }}">
                            <i class="icofont icofont-triangle text-light"></i>&nbsp;&nbsp;&nbsp;
                            <span>Categoría</span>
                        </a>
                    </li>
                    {{-- <li class="sidebar-list {{ Request::is('subcategory') ? 'active' : '' }}"><i class="fa fa-thumb-tack"></i>
